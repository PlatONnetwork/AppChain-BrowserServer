...
CREATE database if NOT EXISTS `appchain_xxl_job` default character set utf8mb4 collate utf8mb4_unicode_ci;
use `appchain_xxl_job`;
...
INSERT INTO `xxl_job_group`(`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (2, 'appchain-scan-job', 'scan-job定时任务', 0, NULL, '2021-12-09 09:53:38');
INSERT INTO `xxl_job_group`(`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (3, 'appchain-scan-agent', 'agent定时任务', 0, NULL, '2021-12-09 09:53:38');
