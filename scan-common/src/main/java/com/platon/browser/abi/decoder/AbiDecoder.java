package com.platon.browser.abi.decoder;


import com.platon.browser.abi.difinition.AbiDefinition;
...
public class AbiDecoder {
    ...
    public AbiDecoder(String abiFilePath) throws IOException {
        File file = new File(abiFilePath);
        String abi  = FileUtils.readFileToString(file, StandardCharsets.UTF_8);
        this.abi = AbiDefinition.fromJson(abi);
        init();
